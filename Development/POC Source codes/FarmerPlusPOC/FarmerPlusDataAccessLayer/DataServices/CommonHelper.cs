    ...
    public class CommonHelper
    {
       ...
       /// <returns></returns>
         ...
         public DataSet GetComplaints(int service_id, int category_id)
        {
            ...
            try
            {
                MySqlDataAdapter dapt = new MySqlDataAdapter("SELECT LG.ID, LG. AS COMPLAINT, LG.PHONE_NUMBER, C.NAME AS CITY_NAME, LG.FOLLOWUP, DATE_TIME AS COMPLAINT_TIME   FROM COMPLAINTLOG LG, CITIES C, LOOKUPS CATEG_L, LOOKUPS SERV_L, SEMANTICS S " +
